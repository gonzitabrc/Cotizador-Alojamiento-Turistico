/**
*
* Cotizador Online para Alojamiento Turístico 
* 
* Cotiza el valor del tu alojamiento temporario, y permite a tu cliente enviar la solicitud de reserva por email
*
* Version: 1.1
*
...
function doGet() {
  return HtmlService.createHtmlOutputFromFile('Index')
      .setTitle('Cotizador de alojamiento temporario')
...
function enviarCorreo(datos) {
  ...
  var fechaRetiroFormateada = formatearFecha(new Date(datos.fechaCheckIn));
  var fechaDevolucionFormateada = formatearFecha(new Date(datos.fechaCheckOut));
  ...
  var cuerpo = 
    ...
    '<p><strong>Fecha de check in:</strong> ' + fechaRetiroFormateada + '</p>' +
    '<p><strong>Fecha de check out:</strong> ' + fechaDevolucionFormateada + '</p>' +
    '<p><strong>Unidad:</strong> ' + datos.categoria + '</p>' +
